...
var MarkdownDeep = new function () {
  ...
  p.EvaluateLineInternal = function (p, b) {
    ...
    if (ch == '>' || p.buf.substring(p.m_position, p.m_position+4) == '&gt;') {
      var pos = (ch == '>')? 1 : 3;
      // Block quote followed by space
      if (is_linespace(p.CharAtOffset(pos++))) {
...
angular.module('wiz.markdown')
  ...
  .filter('wizMarkdownFltr', ['wizMarkdownSvc', function (wizMarkdownSvc) {
    ...
    return function (input) {
      ...
      if (input){
        return wizMarkdownSvc.Transform(input);
...
angular.module('wiz.markdown')
  ...
  .directive('wizToolbarButton', function () {
    return {
      ...
      transclude: true,
      scope: {},
      template: '<button type="button" class="btn btn-default" ng-click="format()" ng-transclude></button>',
