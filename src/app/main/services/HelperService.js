(function (helpSystems) {
    ...
    var HelperService = ['$rootScope', '$http', function ($rootScope, $http) {
        ...
        Helper.getProfileList = function (params, id) {
            ...
            // 6 columns
            return {"userProfiles":{"structure":{"actions":true,"totalRecords":6,"currentRecord":1,"sentRecords":6,"dateCollected":1487828589339,"columns":{"id":"ID","name":"Name","age":"Age","username":"userName","hasPassword":"hasPassword","address":"Address"}},"data":[{"id":16,"actions":["Details","Delete","Fire"],"name":"bnm","username":"bnm","age":24,"address":"192.168.0.1","removed":false,"hasPassword":true,"connections":[],"iseries":[],"action_disabled":false,"action_editable":true},{"id":15,"actions":["Details","Delete"],"name":"dfg","username":"dfg","removed":false,"age":25,"address":"192.168.0.2","hasPassword":true,"connections":[],"iseries":[],"action_disabled":false,"action_editable":true},{"id":3,"actions":["Details","Delete"],"name":"MIKEE","username":"MIKEE","removed":false,"age":26,"address":"192.168.0.3","hasPassword":true,"connections":[],"iseries":[],"action_disabled":false,"action_editable":true},{"id":17,"actions":["Details","Delete"],"name":"sx","username":"sarixach","removed":false,"hasPassword":true,"age":50,"address":"192.168.0.5","connections":[],"iseries":[],"action_disabled":false,"action_editable":true},{"id":4,"actions":["Details","Delete"],"name":"TEST","username":"TEST","removed":false,"age":99,"address":"192.168.0.100","hasPassword":true,"connections":[],"iseries":[],"action_disabled":false,"action_editable":true},{"id":2,"actions":["Details","Delete"],"name":"User00","username":"User00","removed":false,"age":70,"address":"192.168.0.101","hasPassword":true,"connections":[],"iseries":[],"action_disabled":false,"action_editable":true}]}};
